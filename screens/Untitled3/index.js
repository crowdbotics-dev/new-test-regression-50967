...
const Untitled3 = ({
  ...
  return <SafeAreaView style={styles.safeArea}>
      ...
      position: 'relative',
      flex: 1
    }}><ImageBackground style={styles.VhnDLHNv} source={{
      ...
      }} resizeMode="cover"></ImageBackground><View style={styles.rXvKXnjK}><Text style={styles.EGcDUNRI}>Lorem ipsum…</Text></View><View style={styles.bdsMRInc}></View></ScrollView>
    </SafeAreaView>;
};
