"""
Django settings for new_test_regression_50967 project.
...
ROOT_URLCONF = 'new_test_regression_50967.urls'
...
WSGI_APPLICATION = 'new_test_regression_50967.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "new_test_regression_50967 API",
    "DESCRIPTION": "API documentation for new_test_regression_50967 App",
    "VERSION": "v1",
}
