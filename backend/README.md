...
## Project Structure
    ...
    ├── new_test_regression_50967  # Django project configurations
...
1. Clone this repo and `cd new_test_regression_50967`
...
2. Clone this repo and `cd new_test_regression_50967`
